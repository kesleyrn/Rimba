...
<u class="Hu"><p class="Heading">All Sandals</p></u>
   <div class="container">
        ...
        $sql = "SELECT * FROM `products` WHERE Product_name = 'Sandals' ORDER BY id DESC LIMIT $startingLimit, $numberPerPage";
        ...
        <div class="pagination">
          ...
          for($btn = 1; $btn <= $totalPages; $btn++){
              echo '<button class="btn"><a href="allsandals.php?page=' . $btn . '">' . $btn . '</a></button>';
          }
          ?>
        </div>
