...
<body>
<u class="Hu"><p class="Heading">Women Dresses</p></u>
    <div class="container">
        <?php
        ...
        $sql = "SELECT * FROM `products` WHERE Product_name = 'Dress' AND Gender = 'Female' ORDER BY id DESC LIMIT $startingLimit, $numberPerPage";
