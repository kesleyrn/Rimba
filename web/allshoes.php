...
<body>
<u class="Hu"><p class="Heading">All Shoes</p></u>
   <div class="container">
        <?php
        ...
        $sql = "SELECT * FROM `products` WHERE Product_name = 'Closed Shoes' ORDER BY id DESC LIMIT $startingLimit, $numberPerPage";
        ...
        <div class="pagination">
          ...
          for($btn = 1; $btn <= $totalPages; $btn++){
              echo '<button class="btn"><a href="allshoes.php?page=' . $btn . '">' . $btn . '</a></button>';
          }
          ?>
        </div>
