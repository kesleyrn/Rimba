...
<body>
<u class="Hu"><p class="Heading">Women Bags</p></u>
   <div class="container">
        <?php
        ...
        $sql = "SELECT * FROM `products` WHERE Product_name = 'bag' AND Gender = 'Female' ORDER BY id DESC LIMIT $startingLimit, $numberPerPage";
        ...
        <div class="pagination">
          ...
          for($btn = 1; $btn <= $totalPages; $btn++){
              echo '<button class="btn"><a href="wbag.php?page=' . $btn . '">' . $btn . '</a></button>';
          }
          ?>
        </div>
